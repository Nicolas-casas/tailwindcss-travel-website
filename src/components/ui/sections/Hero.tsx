	...
	<section className='w-full h-screen relative'>
		...
		<div className='absolute left-1/2 top-1/2 w-full -translate-x-1/2 -translate-y-1/2'>
			<div className='container mx-auto flex flex-col items-center justify-center text-center text-white p-4 gap-4'>
				...
				<form className='flex xs:flex-wrap justify-between items-center gap-4 max-w-[700px] mx-auto w-full border py-1 px-2 rounded-md text-black bg-gray-100/90'>
					<input
					...
					/>
					<button className={'xs:flex-grow flex-grow-0 text-center'}>
						<AiOutlineSearch
							className='icon !text-white xs:mx-auto'
							size={20}
						/>
					</button>
				</form>
